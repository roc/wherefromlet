javascript:(function(){
    ...
    fEl = document.body.childNodes[0],
    got = '<strong>Referrer: <a style="border-bottom: 1px dotted Snow;color: FloralWhite;text-decoration:none" href="'+r+'">'+r+'</a>',
    notGot = 'Unable to find a referrer for this page.',
    t = (r != null && r !=="") ? got : notGot;
    ...
    div.innerHTML = '<a href="#" id="_remover_" style="float:right;padding:1px 6px;background:red;color:white;text-decoration:none;border-radius:10px;margin:-15px">x</a>'+t+'</strong>';
